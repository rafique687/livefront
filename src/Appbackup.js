...
import Sales from "./ecommerce/backend/Sales";
...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      {
        index: true,  // default child route for /sales
        element: (
          <SalesDashboard
            totalSales={250000}
      ...
      {
        path: "Orders",  // relative path: /sales/Orders
        element: <OrderDetails order={dummyOrder} />,
      },
      {
        path: "AOVList",  // relative path: /sales/AOVList
        element: <AOVList />,
      },
    ],
  },
